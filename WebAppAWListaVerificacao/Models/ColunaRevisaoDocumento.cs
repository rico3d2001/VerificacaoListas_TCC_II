...
{
    public class ColunaRevisaoDocumento
    {
        ...
        public ColunaRevisaoDocumento(string indiceRevisao, string dataRevisaoExistente, string nomeVerificador, string loginVerificaro, int ordenador, string idSiglaVerificador)
        {
